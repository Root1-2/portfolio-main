        ...
        <div className="rounded-lg bg-neutral-900 px-2 py-3 sm:px-8 sm:py-5">
          ...
          >
            {projects
              ...
              .map((project) =>
                project.unavailable ? (
                  <div className="group relative h-44 w-80 scale-90 transform cursor-pointer rounded-lg bg-gradient-to-r transition duration-300 ease-in-out hover:scale-100 hover:bg-gradient-to-r hover:from-gray-900 hover:to-gray-400">
                    <img
                  ...
                  <NavLink to={`/project/${project.id}`} key={project.id}>
                    <div className="group relative h-44 w-80 scale-90 transform cursor-pointer rounded-lg bg-gradient-to-r transition duration-300 ease-in-out hover:scale-100 hover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-700">
                      <img
                        src={project.thumbnail}
                        className="absolute left-0 top-0 h-full w-full rounded-lg object-cover transition-opacity duration-300 ease-in-out group-hover:opacity-50"
                        alt={project.name}
